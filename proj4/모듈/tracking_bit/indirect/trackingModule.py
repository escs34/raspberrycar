#########################################################################
### Date: 2017/10/13 file name: trackingModule.py Purpose: this code has 
### been generated for the five-way tracking sensor
...
def navigator():
	...
	if bit==8 or bit>15 or 0<bit<3:
		recentBit[1]=recentBit[0]
		recentBit[0]=bit
	return bit
...
if __name__ == "__main__":
	while True:
		print(bitCount())
		print("write", navigator())
		print("read", recentBit)
